package com.example.android.eduquiz;
...
public class MainActivity extends AppCompatActivity {
    ...
    final String Q4_ANSWER = "Australia";
    ...
    public void clearAnswers(View v) {

        RadioButton rg = (RadioButton) findViewById(R.id.question_1_first_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_1_second_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_1_third_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_2_first_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_2_second_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_2_third_logo_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_5_first_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_5_second_radio);
        rg.setChecked(false);
        rg = (RadioButton) findViewById(R.id.question_5_third_radio);
        rg.setChecked(false);
        CheckBox cb = (CheckBox) findViewById(R.id.question_3_first_checkbox);
        cb.setChecked(false);
        cb = (CheckBox) findViewById(R.id.question_3_second_checkbox);
        cb.setChecked(false);
        cb = (CheckBox) findViewById(R.id.question_3_third_checkbox);
        cb.setChecked(false);
        cb = (CheckBox) findViewById(R.id.question_3_fourth_checkbox);
        cb.setChecked(false);
    ...
    public void checkQuiz(View v) {
        ...
        if (numberOfQuestionsCorrect ==5)
            text = "You got " + numberOfQuestionsCorrect + "/5 answers right.\n\nGreat!\n";
        else
